...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Canvas = function Canvas(el, holder) {
	  ...
	  var drawParallelogram = function drawParallelogram() {
	    (0, _Parallelogram2.default)(circles[0], circles[1], circles[2]).draw();
	  };

	  var drawCircles = function drawCircles(e) {

	    if (circles.length < 3) {
	      var cicle = (0, _circle2.default)([e.offsetX, e.offsetY], 11, gl, '#e6e600').draw();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Parallelogram = function Parallelogram(_pointA, _pointB, _pointC, gl) {
	  var pointA = _pointA;
	  var pointB = _pointB;
	  var pointC = _pointC;
	  var pointD;
