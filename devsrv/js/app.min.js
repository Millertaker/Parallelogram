...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Canvas = function Canvas(el, holder) {
	  ...
	  var drawCircles = function drawCircles(e) {
	    ...
	    if (circles.length === 0) document.querySelector('.pointA').innerHTML = '[ ' + e.offsetX + ' ,  ' + e.offsetY + ' ]';else if (circles.length === 1) document.querySelector('.pointB').innerHTML = '[ ' + e.offsetX + ' ,  ' + e.offsetY + ' ]';else if (circles.length === 2) document.querySelector('.pointC').innerHTML = '[ ' + e.offsetX + ' ,  ' + e.offsetY + ' ]';
	  ...
	  var reDraw = function reDraw() {
	    ...
	    for (var i in circles) {
	      ...
	      if (i == 0) document.querySelector('.pointA').innerHTML = '[ ' + circles[i][0] + ' ,  ' + circles[i][0] + ' ]';else if (i == 1) document.querySelector('.pointB').innerHTML = '[ ' + circles[i][0] + ' ,  ' + circles[i][0] + ' ]';else if (i == 2) document.querySelector('.pointC').innerHTML = '[ ' + circles[i][0] + ' ,  ' + circles[i][0] + ' ]';
